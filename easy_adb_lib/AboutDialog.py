...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AboutEasyAdbDialog')
        new_object = builder.get_object("about_easy_adb_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        to finish initializing the start of the new AboutEasyAdbDialog
        instance.
